...
<body class='login'>
	...
	<div class='content'>
		...
		<form class='form-vertical login-form' action='' method='post'>
			<h3 class='form-title'><center>Bienvenido</center></h3>
			<div class='alert alert-error hide'>
				<button class='close' data-dismiss='alert'></button>
				<span>Enter any username and password.</span>
			</div>";
        echo"<form action=login.php name=form1 method=POST>
		<div class='control-group'>
				...
				<div class='controls'>
					<div class='input-icon left'>
						<i class='icon-user'></i>
						<input class='m-wrap placeholder-no-fix' type='text' autocomplete='off' placeholder='Username' name='nombre'/>
					</div>
				</div>
			</div>
		<div class='control-group'>
				...
				<div class='controls'>
					<div class='input-icon left'>
						<i class='icon-lock'></i>
						<input class='m-wrap placeholder-no-fix' type='password' autocomplete='off' placeholder='Password' name='passw'/>
					</div>
				</div>
			</div>
			<div class='form-actions'>
				...
				<button type='submit' class='btn blue pull-right' name='op' value='enviar'>
			...
			echo"<form class='form-vertical forget-form' action='index.html' method='post'>
...
<!-- END BODY -->
    ...
    public function validarUsuario($nombre,$passw){
        $sql="Select * from usuario where Usuario='$nombre' AND Contrasena='$passw'";
